  ...
  const HandleNotifications = (e) => {
    ...
    let getNotes = async () => {
      let response = await fetch(
        `${process.env.REACT_APP_API_URL}/app/stats/notify/case/status/${ids}/`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          ...
          body: JSON.stringify({ remarks, message }),
        }
      );
  ...
  return (
    <div className="w-full px-6 py-6 mx-auto drop-zone loopple-min-height-78vh text-slate-500">
      ...
      <div
        ...
        draggable="true"
      >
        <div className="grid lg:grid-cols-2 grid-cols-1 -mx-3">
          <div className="cont col-span-1 flex">
            ...
            <div className=" w-auto max-w-full px-3 my-auto ">
              <div className="h-full space-y-2">
                <h1>
                  <strong className="text-slate-700 text-xl ">Status :</strong>{" "}
                  <span className=" py-[3px] px-2 rounded-lg text-xs font-semibold bg-green-400 text-white">
                    Found
                  </span>
                </h1>
                <h5 className="mb-1">
          ...
          <div className="notify col-span-1 lg:text-right px-4 lg:pr-4 lg:pt-0 pt-4  ">
            <FeedbackModal
